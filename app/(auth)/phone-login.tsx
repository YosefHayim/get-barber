...
import { PhoneAuthInput, OTPInput } from '@/features/auth/components';
import { usePhoneAuth } from '@/features/auth/hooks';
...
export default function PhoneLoginScreen(): React.JSX.Element {
  ...
  const { sendOTP, verifyOTP, resendOTP, isLoading, error: authError } = usePhoneAuth();
          ...
          {step === 'phone' ? (
            ...
            <>
              ...
              <Text className="text-base text-gray-500 font-medium text-center leading-6">
                ...
                <Text className="text-primary-500 font-bold">+972 {formatDisplayPhone(phone)}</Text>
              </Text>
            </>
          )}
        </Animated.View>
